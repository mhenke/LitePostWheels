<cffunction name="redirectTo" returntype="void" access="public" output="false"
	hint="Redirects the browser to the supplied controller/action/key, route or back to the referring page. Internally It uses the URLFor function to build the link and the cflocation tag to perform the redirect."
	examples=
	'
		<cfif user.save()>
